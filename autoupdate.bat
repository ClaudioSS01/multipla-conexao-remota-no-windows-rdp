...
REM                        autoupdate.bat
REM
REM Automatic RDP Wrapper installer and updater // asmtron (12-09-2020)
REM -------------------------------------------------------------------
REM Options:
...
REM   of other contributors like the one of "DrDrrae, saurav-biswas, affinityv".
...
REM -----------------------------------------
set rdpwrap_ini_update_github_1="https://raw.githubusercontent.com/conankiz/RDPWrapper/main/rdpwrap.ini"
...
set rdpwrap_ini_update_github_4="https://raw.githubusercontent.com/affinityv/INI-RDPWRAP/master/rdpwrap.ini"
